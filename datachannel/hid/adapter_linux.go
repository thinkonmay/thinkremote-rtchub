...
var (
	keycodes = []KeyCode{
		...
		{0x11 /* VKEY_CONTROL */, LINUX_KEY_LEFTCTRL, 0x700E0},
		...
		{0x1B /* VKEY_ESCAPE */, LINUX_KEY_ESC, 0x70029},
		{0x20 /* VKEY_SPACE */, LINUX_KEY_SPACE, 0x7002C},
		{0x21 /* VKEY_PRIOR */, LINUX_KEY_PAGEUP, 0x7004B},
		{0x22 /* VKEY_NEXT */, LINUX_KEY_PAGEDOWN, 0x7004E},
		{0x23 /* VKEY_END */, LINUX_KEY_END, 0x7004D},
		{0x24 /* VKEY_HOME */, LINUX_KEY_HOME, 0x7004A},
		{0x25 /* VKEY_LEFT */, LINUX_KEY_LEFT, 0x70050},
		{0x26 /* VKEY_UP */, LINUX_KEY_UP, 0x70052},
		{0x27 /* VKEY_RIGHT */, LINUX_KEY_RIGHT, 0x7004F},
		{0x28 /* VKEY_DOWN */, LINUX_KEY_DOWN, 0x70051},
		{0x29 /* VKEY_SELECT */, LINUX_KEY_SELECT, UNKNOWN},
		{0x2A /* VKEY_PRINT */, LINUX_KEY_PRINT, UNKNOWN},
		{0x2C /* VKEY_SNAPSHOT */, LINUX_KEY_SYSRQ, 0x70046},
		{0x2D /* VKEY_INSERT */, LINUX_KEY_INSERT, 0x70049},
		{0x2E /* VKEY_DELETE */, LINUX_KEY_DELETE, 0x7004C},
		{0x2F /* VKEY_HELP */, LINUX_KEY_HELP, UNKNOWN},
		...
		{0x5B /* VKEY_LWIN */, LINUX_KEY_LEFTMETA, 0x700E3},
		{0x5C /* VKEY_RWIN */, LINUX_KEY_RIGHTMETA, 0x700E7},
		{0x5F /* VKEY_SLEEP */, LINUX_KEY_SLEEP, UNKNOWN},
		{0x60 /* VKEY_NUMPAD0 */, LINUX_KEY_KP0, 0x70062},
		{0x61 /* VKEY_NUMPAD1 */, LINUX_KEY_KP1, 0x70059},
		{0x62 /* VKEY_NUMPAD2 */, LINUX_KEY_KP2, 0x7005A},
		{0x63 /* VKEY_NUMPAD3 */, LINUX_KEY_KP3, 0x7005B},
		{0x64 /* VKEY_NUMPAD4 */, LINUX_KEY_KP4, 0x7005C},
		{0x65 /* VKEY_NUMPAD5 */, LINUX_KEY_KP5, 0x7005D},
		{0x66 /* VKEY_NUMPAD6 */, LINUX_KEY_KP6, 0x7005E},
		{0x67 /* VKEY_NUMPAD7 */, LINUX_KEY_KP7, 0x7005F},
		{0x68 /* VKEY_NUMPAD8 */, LINUX_KEY_KP8, 0x70060},
		{0x69 /* VKEY_NUMPAD9 */, LINUX_KEY_KP9, 0x70061},
		{0x6A /* VKEY_MULTIPLY */, LINUX_KEY_KPASTERISK, 0x70055},
		{0x6B /* VKEY_ADD */, LINUX_KEY_KPPLUS, 0x70057},
		{0x6C /* VKEY_SEPARATOR */, LINUX_KEY_KPCOMMA, UNKNOWN},
		{0x6D /* VKEY_SUBTRACT */, LINUX_KEY_KPMINUS, 0x70056},
		{0x6E /* VKEY_DECIMAL */, LINUX_KEY_KPDOT, 0x70063},
		{0x6F /* VKEY_DIVIDE */, LINUX_KEY_KPSLASH, 0x70054},
		{0x70 /* VKEY_F1 */, LINUX_KEY_F1, 0x70046},
		{0x71 /* VKEY_F2 */, LINUX_KEY_F2, 0x70047},
		{0x72 /* VKEY_F3 */, LINUX_KEY_F3, 0x70048},
		{0x73 /* VKEY_F4 */, LINUX_KEY_F4, 0x70049},
		{0x74 /* VKEY_F5 */, LINUX_KEY_F5, 0x7004a},
		{0x75 /* VKEY_F6 */, LINUX_KEY_F6, 0x7004b},
		{0x76 /* VKEY_F7 */, LINUX_KEY_F7, 0x7004c},
		{0x77 /* VKEY_F8 */, LINUX_KEY_F8, 0x7004d},
		{0x78 /* VKEY_F9 */, LINUX_KEY_F9, 0x7004e},
		{0x79 /* VKEY_F10 */, LINUX_KEY_F10, 0x70044},
		{0x7A /* VKEY_F11 */, LINUX_KEY_F11, 0x70044},
		{0x7B /* VKEY_F12 */, LINUX_KEY_F12, 0x70045},
		{0x7C /* VKEY_F13 */, LINUX_KEY_F13, 0x7003a},
		{0x7D /* VKEY_F14 */, LINUX_KEY_F14, 0x7003b},
		{0x7E /* VKEY_F15 */, LINUX_KEY_F15, 0x7003c},
		{0x7F /* VKEY_F16 */, LINUX_KEY_F16, 0x7003d},
		{0x80 /* VKEY_F17 */, LINUX_KEY_F17, 0x7003e},
		{0x81 /* VKEY_F18 */, LINUX_KEY_F18, 0x7003f},
		{0x82 /* VKEY_F19 */, LINUX_KEY_F19, 0x70040},
		{0x83 /* VKEY_F20 */, LINUX_KEY_F20, 0x70041},
		{0x84 /* VKEY_F21 */, LINUX_KEY_F21, 0x70042},
		{0x85 /* VKEY_F22 */, LINUX_KEY_F12, 0x70043},
		{0x86 /* VKEY_F23 */, LINUX_KEY_F23, 0x70044},
		{0x87 /* VKEY_F24 */, LINUX_KEY_F24, 0x70045},
		{0x90 /* VKEY_NUMLOCK */, LINUX_KEY_NUMLOCK, 0x70053},
		{0x91 /* VKEY_SCROLL */, LINUX_KEY_SCROLLLOCK, 0x70047},
		{0xA0 /* VKEY_LSHIFT */, LINUX_KEY_LEFTSHIFT, 0x700E1},
		{0xA1 /* VKEY_RSHIFT */, LINUX_KEY_RIGHTSHIFT, 0x700E5},
		{0xA2 /* VKEY_LCONTROL */, LINUX_KEY_LEFTCTRL, 0x700E0},
		{0xA3 /* VKEY_RCONTROL */, LINUX_KEY_RIGHTCTRL, 0x700E4},
		{0xA4 /* VKEY_LMENU */, LINUX_KEY_LEFTALT, 0x7002E},
		{0xA5 /* VKEY_RMENU */, LINUX_KEY_RIGHTALT, 0x700E6},
		{0xBA /* VKEY_OEM_1 */, LINUX_KEY_SEMICOLON, 0x70033},
		{0xBB /* VKEY_OEM_PLUS */, LINUX_KEY_EQUAL, 0x7002E},
		{0xBC /* VKEY_OEM_COMMA */, LINUX_KEY_COMMA, 0x70036},
		{0xBD /* VKEY_OEM_MINUS */, LINUX_KEY_MINUS, 0x7002D},
		{0xBE /* VKEY_OEM_PERIOD */, LINUX_KEY_DOT, 0x70037},
		{0xBF /* VKEY_OEM_2 */, LINUX_KEY_SLASH, 0x70038},
		{0xC0 /* VKEY_OEM_3 */, LINUX_KEY_GRAVE, 0x70035},
		{0xDB /* VKEY_OEM_4 */, LINUX_KEY_LEFTBRACE, 0x7002F},
		{0xDC /* VKEY_OEM_5 */, LINUX_KEY_BACKSLASH, 0x70031},
		{0xDD /* VKEY_OEM_6 */, LINUX_KEY_RIGHTBRACE, 0x70030},
		{0xDE /* VKEY_OEM_7 */, LINUX_KEY_APOSTROPHE, 0x70034},
		{0xE2 /* VKEY_NON_US_BACKSLASH */, LINUX_KEY_102ND, 0x70064},
	}
...
i    C.libevdev_uinput_write_event(keyboard_input, , 23, C.int(code));
}
